...
:::demo Bind `v-model` to a `Boolean` typed variable. The `--ty-switch-on-color` and `--ty-switch-off-color` CSS variables decides the background color in two states.
...
| active-color ^(deprecated)    | background color when in `on` state ( use CSS var `--ty-switch-on-color` instead )                                                              | ^[string]                                      | ''      |
| inactive-color ^(deprecated)  | background color when in `off` state ( use CSS var `--ty-switch-off-color` instead )                                                            | ^[string]                                      | ''      |
| border-color ^(deprecated)    | border color of the switch ( use CSS var `--ty-switch-border-color` instead )                                                                   | ^[string]                                      | ''      |
