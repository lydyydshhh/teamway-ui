...
:::demo 可通过 `toolbar` 插槽自定义工具栏内容，插槽中添加了 `setActiveItem` 方法，用于根据索引切换图片。
...
:::demo 可通过 `show-progress` 控制是否在预览图片时显示进度条。 进度条会在使用 `progress` 插槽时显示。
...
| show-progress         | 是否在预览图片时显示进度条                                                                                                | ^[boolean]                                                              | false  |
...
| ------------ | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| viewer       | 自定义内容                                       | -                                                                                                                                                                                                                 |
| progress     | 自定义进度内容 (优先级高于 `show-progress` prop) | ^[object]`{ activeIndex: number, total: number }`                                                                                                                                                                 |
| toolbar      | 自定义工具栏内容                                 | ^[object]`{actions: (action: ImageViewerAction, options?: ImageViewerActionOptions ) => void, prev: ()=> void, next: () => void,reset: () => void, activeIndex: number }, setActiveItem: (index: number) => void` |
| viewer-error | 自定义图像加载失败的内容                         | ^[object]`{ activeIndex: number, src: string }`                                                                                                                                                                   |
