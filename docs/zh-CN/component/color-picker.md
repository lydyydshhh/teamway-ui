...
| popper-style                | ColorPicker 下拉面板的自定义样式                                                                   | ^[string] / ^[object]                                                                                            | —      |
...
| empty-values                | 组件的空值配置 [参考config-provider](/en-US/component/config-provider#empty-values-configurations) | ^[array]                                                                                                         | —      |
| value-on-clear              | 清空选项的值 [参考 config-provider](/en-US/component/config-provider#empty-values-configurations)  | ^[string] / ^[number] / ^[boolean] / ^[Function]                                                                 | —      |
...
| persistent                  | 当颜色选择器未激活且 persistent 为 false 时，颜色面板将被销毁。                                    | ^[boolean]                                                                                                       | true   |
| append-to                   | 挂载到哪个 DOM 元素                                                                                | ^[CSSSelector] / ^[HTMLElement]                                                                                  | -      |
