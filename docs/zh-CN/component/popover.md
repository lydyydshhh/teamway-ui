...
Popover 是在 `TyTooltip` 基础上开发出来的。 因此对于重复属性，请参考 Tooltip 的文档，在此文档中不做详尽解释。
...
| title                              | 标题                                                                                                                                        | ^[string]                                                                                                                                                                   | —                                                                          |
| effect                             | Tooltip 主题，TeamwayUI 内置了 `dark` / `light` 两种主题                                                                                    | ^[enum]`'dark' \| 'light'` / ^[string]                                                                                                                                      | light                                                                      |
...
| transition                         | 定义渐变动画，默认是 ty-fade-in-linear                                                                                                      | ^[string]                                                                                                                                                                   | —                                                                          |
| show-arrow                         | 是否显示 Tooltip 箭头， 欲了解更多信息，请参考 [TyPopper](https://github.com/element-plus/element-plus/tree/dev/packages/components/popper) | ^[boolean]                                                                                                                                                                  | true                                                                       |
