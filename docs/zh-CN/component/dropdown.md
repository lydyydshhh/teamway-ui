...
| trigger-keys       | 指定键盘上哪些按键可以触发操作                                                                           | ^[array]`string[]`                                                                                           | `['Enter', 'Space', 'ArrowDown', 'NumpadEnter']`                           |
| virtual-triggering | 是否启用虚拟触发器                                                                                       | ^[boolean]                                                                                                   | —                                                                          |
| virtual-ref        | 指示下拉框所依附的参考元素                                                                               | ^[HTMLElement]                                                                                               | —                                                                          |
...
| append-to          | dropdown 的内容将挂载到哪一个元素上                                                                      | ^[CSSSelector] / ^[HTMLElement]                                                                              | :::                                                                        |
