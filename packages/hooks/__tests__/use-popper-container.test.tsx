...
describe('no injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toMatch(/^ty-popper-container-\d{0,4}$/)
    expect(wrapper.vm.selector).toMatch(/^#ty-popper-container-\d{0,4}$/)
...
describe('with injection value', () => {
  ...
  it('usePopperContainerId', () => {
    ...
    expect(wrapper.vm.id).toBe('ty-popper-container-1024')
    expect(wrapper.vm.selector).toBe('#ty-popper-container-1024')
  })
})
