...
describe('Collapse.vue', () => {
  ...
  test('title slot', async () => {
    ...
    await wrapper.find('.ty-collapse-item__header').trigger('click')
  ...
  describe('Nested Input Interaction', () => {
    ...
    test('should not toggle collapse when clicking on input', async () => {
      ...
      const header = wrapper.find('.ty-collapse-item__header')
  ...
  describe('Accessibility', () => {
    test('should have appropriate ARIA attributes', async () => {
      ...
      collapseItemWrappers.forEach((item, index) => {
        const header = item.find('.ty-collapse-item__header')
        const content = item.find('.ty-collapse-item__wrap')
