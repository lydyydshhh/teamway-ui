...
describe('Autocomplete.vue', () => {
  ...
  test('popperClass', async () => {
    ...
    expect(
      document.body.querySelector('.ty-popper')?.classList.contains('error')
    ).toBe(true)
    ...
    expect(
      document.body.querySelector('.ty-popper')?.classList.contains('success')
    ).toBe(true)
  })

  test('teleported', async () => {
    _mount({ teleported: false })
    expect(document.body.querySelector('.ty-popper__mask')).toBeNull()
  })
  ...
  test('hideLoading', async () => {
    ...
    expect(document.body.querySelector('.ty-icon.is-loading')).toBeDefined()
    await wrapper.setProps({ hideLoading: true })
    expect(document.body.querySelector('.ty-icon.is-loading')).toBeNull()
  })
  ...
  test('fitInputWidth', async () => {
    ...
    const inputDom = wrapper.find('.ty-input').element
  ...
  describe('test a11y supports', () => {
    test('test a11y attributes', async () => {
      ...
      const container = wrapper.find('.ty-autocomplete')
  ...
  describe('new slots: header & footer', () => {
    test('header slot renders', async () => {
      ...
      const headerEl = document.body.querySelector(
        '.ty-autocomplete-suggestion__header'
      )
    ...
    test('should render footer slot', async () => {
      ...
      const footerEl = document.body.querySelector(
        '.ty-autocomplete-suggestion__footer'
      )
