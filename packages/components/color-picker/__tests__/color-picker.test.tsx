...
describe('Color-picker', () => {
  ...
  it('should show alpha slider when show-alpha=true', async () => {
    ...
    await wrapper.find('.ty-color-picker__trigger').trigger('click')
    const alphaSlider = document.querySelector('.ty-color-alpha-slider')
  ...
  it('should show color picker when click trigger', async () => {
    ...
    await wrapper.find('.ty-color-picker__trigger').trigger('click')
    const panel = document.querySelector('.ty-color-picker-panel')
  ...
  it("should set '' as null when confirm button click", async () => {
    ...
    await _wrapper.find('.ty-color-picker__trigger').trigger('click')

    const wrapper = _wrapper.findComponent(ColorPickerPanel)
    await wrapper.find('.ty-color-footer__btn')?.trigger('click')
  ...
  describe('form item accessibility integration', () => {
    it('automatic id attachment', async () => {
      ...
      const colorPickerButton = wrapper.find('.ty-color-picker')
  ...
  it('it will target the focus & blur', async () => {
    ...
    await nextTick()
    await wrapper.find('.ty-color-picker').trigger('focus')
    expect(focusHandler).toHaveBeenCalledTimes(1)

    await wrapper.find('.ty-color-picker').trigger('blur')
  ...
  it('a11y', async () => {
    ...
    await nextTick()
    const colorPickerButton = wrapper.find('.ty-color-picker')
    const colorPickerPanel = wrapper.find('.ty-color-picker__panel')
    ...
    await wrapper.find('.ty-color-picker__trigger').trigger('click')
    await rAF()
    expect(wrapper.find('.ty-input__wrapper.is-focus')).toBeTruthy()
