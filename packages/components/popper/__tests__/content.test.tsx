...
import { POPPER_INJECTION_KEY } from '@teamway-ui/components/popper'
import TyContent from '../src/content.vue'
...
const TestComponent = defineComponent({
  ...
  render() {
    return (
      <TyContent ref="contentRef" {...this.$attrs}>
        {AXIOM}
      </TyContent>
    )
  },
...
const mountContent = (props = {}) =>
  mount(<TyContent {...props}>{AXIOM}</TyContent>, {
    global: {
      provide: {
