...
describe('Alert.vue', () => {
  test('render test & class', () => {
    ...
    expect(wrapper.find('.ty-alert__title').text()).toEqual(AXIOM)
    expect(wrapper.find('.ty-alert').classes()).toContain('ty-alert--info')
  })
  ...
  test('type', () => {
    ...
    expect(wrapper.find('.ty-alert').classes()).toContain('ty-alert--success')
    expect(wrapper.find('.ty-alert__icon').classes()).toContain('ty-icon')
  ...
  test('description', () => {
    ...
    expect(wrapper.find('.ty-alert__description').text()).toEqual(AXIOM)
  })

  test('theme', () => {
    const wrapper = mount(() => <Alert title={'test'} effect={'dark'} />)
    expect(wrapper.find('.ty-alert').classes()).toContain('is-dark')
  })
  ...
  test('close', async () => {
    ...
    const closeBtn = wrapper.find('.ty-alert__close-btn')
  ...
  describe('default slot', () => {
    test.each([
      ...
      const description = wrapper.find('.ty-alert__description')
