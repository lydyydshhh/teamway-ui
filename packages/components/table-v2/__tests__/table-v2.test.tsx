...
describe('TableV2.vue', () => {
  test('slots cell', async () => {
    ...
    expect(wrapper.find('.ty-table-v2').exists()).toBe(true)
    const cell = wrapper.findAll('.ty-table-v2__row-cell')

    expect(cell[0].find('.ty-table-v2__cell-text').exists()).toBe(false)
    ...
    expect(cell[1].find('.ty-table-v2__cell-text').exists()).toBe(true)
    expect(cell[1].find('.ty-table-v2__cell-text').text()).toBe('Row 0 - Col 1')
  })
  ...
  test('slots header-cell', async () => {
    ...
    expect(wrapper.find('.ty-table-v2').exists()).toBe(true)
    const cell = wrapper.findAll('.ty-table-v2__header-cell')
    expect(cell[0].find('.ty-table-v2__header-cell-text').exists()).toBe(false)
    expect(cell[0].find('span').exists()).toBe(true)
    expect(cell[0].find('span').text()).toBe(customText)

    expect(cell[1].find('span').exists()).toBe(false)
    expect(cell[1].find('.ty-table-v2__header-cell-text').exists()).toBe(true)
    expect(cell[1].find('.ty-table-v2__header-cell-text').text()).toBe(
      'Column 1'
    )
  })
  ...
  test('slots empty', async () => {
    ...
    let defaultEmpty = wrapper.find('.ty-empty')
    ...
    defaultEmpty = wrapper.find('.ty-empty')
  ...
  test('slots cell scope', async () => {
    ...
    expect(wrapper.find('.ty-table-v2').exists()).toBe(true)
    const cell = wrapper.find('.ty-table-v2__row-cell')
  ...
  test('slots header-cell scope', async () => {
    ...
    expect(wrapper.find('.ty-table-v2').exists()).toBe(true)
    const cell = wrapper.find('.ty-table-v2__header-cell')
    expect(cell.exists()).toBe(true)
    expect(cell.find('span').text()).toBe(
  ...
  test('respects column flexShrink = 0', async () => {
    ...
    const rowCells = wrapper.findAll('.ty-table-v2__row-cell')
  ...
  describe('a11y', () => {
    test('expand button', async () => {
      ...
      const expandButton = wrapper.find('.ty-table-v2__expand-icon')
    ...
    test('sort button', async () => {
      ...
      const sortButton = wrapper.find('.ty-table-v2__sort-icon')
      const header = wrapper.find('.ty-table-v2__header-cell.is-sortable')
  ...
  test('expand button of sub-row should not apply margin style of icon', async () => {
    ...
    const subExpandButton = wrapper.findAll('.ty-table-v2__expand-icon')[1]
