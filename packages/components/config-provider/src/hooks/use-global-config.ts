...
import { debugWarn, keysOf } from '@teamway-ui/utils'
import {
  SIZE_INJECTION_KEY,
...
// this is meant to fix global methods like `TyMessage(opts)`, this way we can inject current locale
...
// for components like `TyMessage` `TyNotification` `TyMessageBox`.
