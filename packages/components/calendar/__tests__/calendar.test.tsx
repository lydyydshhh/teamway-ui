...
describe('Calendar.vue', () => {
  it('create', async () => {
    ...
    const titleEl = wrapper.find('.ty-calendar__title')
    ...
    const rows = wrapper.element.querySelectorAll('.ty-calendar-table__row')
  ...
  it('range', () => {
    ...
    expect(
      wrapper.element.querySelector('.ty-calendar__button-group')
    ).toBeNull()
  })
  ...
  it('firstDayOfWeek', async () => {
    ...
    const head = wrapper.element.querySelector('.ty-calendar-table thead tr')
  ...
  it('click previous month or next month', async () => {
    ...
    await nextTick()
    const btns = wrapper.findAll('.ty-button')
  ...
  it('slots', async () => {
    ...
    expect(wrapper.find('.ty-calendar__header').text()).toEqual(AXIOM)
