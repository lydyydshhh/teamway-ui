...
describe('<TyTooltipContent />', () => {
  ...
  const createComponent = (props = {}, provides = {}) => {
    const wrapper = mount(
      {
        setup() {
          ...
          return () => <TyTooltipContent {...props}>{AXIOM}</TyTooltipContent>
        },
      },
      {
        global: {
    ...
    return wrapper.findComponent(TyTooltipContent)
  }
